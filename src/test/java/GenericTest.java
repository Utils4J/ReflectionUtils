...
public class GenericTest {
	...
	public void array() {
		...
		assertEquals("java.util.List<java.lang.String>", array.component().getTypeName());
	...
	public void component() {
		...
		assertEquals("java.lang.String", key.getTypeName());
		assertEquals("java.util.List<java.lang.Integer>", value.getTypeName());
	}
	...
	public void wildcard() {
		...
		assertEquals("? extends java.lang.String", component.getTypeName());
